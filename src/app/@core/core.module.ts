...
import { BrandData } from './data/brand-entity';
...
import { AttributeValueData } from './data/attribute-value';
...
const DATA_SERVICES = [
  ...
  { provide: AttributeValueData, useClass: AttributeValueService },
  { provide: RecipeData, useClass: RecipeService },
  { provide: BannerData, useClass: BannerService },
  ...
  ...NbAuthModule.forRoot({
    ...
    strategies: [
      NbPasswordAuthStrategy.setup({
        ...
        baseEndpoint: 'http://59.152.52.154:84/api/',
              login: {
                // ...
                endpoint: 'Authenticate/AuthenticateUser',
                method: 'post',
                redirect: {
                  success: '/product/',
